## 参考项目 https://show.cool-admin.com/

#### 前端地址 git clone https://github.com/cool-team-official/cool-admin-vue.git

```bash
git clone https://gitee.com/cool-team-official/cool-admin-vue.git
```

#### 后端地址 git clone https://github.com/cool-team-official/cool-admin-midway.git
